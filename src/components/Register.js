            ...
            <div>
                ...
                <div className="form-register">
                    ...
                    <form onSubmit={this.register}>
                        ...
                        <input type="text" name="password" className="input-register" placeholder="Password.."/>
                        ...
                        <p>I accep the <span className="text-form">Terms of Use</span> & <span className="text-form">Privacy Policy</span></p>
